package com.devfabio.projectjsf.controllers;
...
/**
 * 
 * @author Soluciones Clase que permite controlar el funcionamiento con la pantalla
 *         login.xhtml
 */
	...
	public void ingresar() {
		...
		if (usuario.equals("fabio") && password.equals("123")) {
			try {
				...
				FacesContext.getCurrentInstance().addMessage("formLogin:txtUsuario", new FacesMessage(FacesMessage.SEVERITY_FATAL, "La página no exite", ""));
				e.printStackTrace();
			}
		} else {
